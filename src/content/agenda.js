...
export const groups = {
  'opening-session': {
    ...
    description:
      'Description of the theme/group. Industry standard tools for artificial intelligence have been designed with several assumptions.'
  },
  'some-other-session': {
...
export const schedule = [
  ...
  },
  {
    ...
    group: groups['some-other-session'],
    description:
